<template>
  <div>
    ...
    <el-table :data="tableData" border row-key="ID" stripe>
      ...
      <el-table-column label="路由Name" min-width="150" prop="name"></el-table-column>
      ...
      <el-table-column label="排序" min-width="50" prop="sort"></el-table-column>
      <el-table-column label="父节点" min-width="50" prop="parentId"></el-table-column>
      <el-table-column label="是否隐藏" min-width="50" prop="hidden">
        <template slot-scope="scope">
