...
import (
	...
	resp "daigou-admin/global/response"
	"daigou-admin/app/service"
...
// @Param data body sys_model.{{.StructName}} true "创建{{.StructName}}"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /{{.Abbreviation}}/create{{.StructName}} [post]
func Create{{.StructName}}(c *gin.Context) {
	var {{.Abbreviation}} sys_model.{{.StructName}}
...
// @accept application/json
// @Produce application/json
// @Param data body sys_model.{{.StructName}} true "删除{{.StructName}}"
...
// @accept application/json
// @Produce application/json
// @Param data body sys_model.{{.StructName}} true "更新{{.StructName}}"
...
// @accept application/json
// @Produce application/json
// @Param data body sys_model.{{.StructName}} true "用id查询{{.StructName}}"
...
func Get{{.StructName}}List(c *gin.Context) {
	...
	if err != nil {
		...
		response.OkWithData(respwrite.PageResult{
			List:     list,
			Total:    total,
			Page:     pageInfo.Page,
